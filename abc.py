...
def gather_data( temps):
    ...
    for i in range(0, len(temps)):
        ...
        average_area_ratio = average_area_rati
...
def def_temp_calc( temps ):
    ...
    if len(temps) > 0:
        for i in range(0, len(temps)):
            ...
            temp = 0
            temp_x = 0
            #ratio = ratio + temps[i][1]/ temps[i][0]
            #area = area + temps[i][0]
            ...
            correction = 1.8 + ((3*temp_x) - 1.25)**3
    ...
    #ratio = ratio/len(temps)
    #area = area/len(temps)
    #print("area", area, "ratio", ratio, "temp", temp)
            ...
            for i in range(0,len(people)): 
                if a -18 < people[i].x < a + 18 and b-18 < people[i].y < b + 18:
                    ...
                    if temperatures[0] != 0 and temperatures[1] > 20:
                        if temperatures[1]/temperatures[0] > 0.35:
